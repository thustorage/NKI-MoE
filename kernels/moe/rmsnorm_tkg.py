...
def rmsnorm_tkg(
    ...
    Args:
        ...
        no_h_interleave (bool): If True, write output in contiguous H layout instead of LNC-interleaved H layout.
...
def process_rmsnorm_tile(
    ...
    # Explicitly upcast bf16 input to fp32 before any computation,
    # to avoid implicit conversion artifacts in activation/tensor_tensor ops.
    ...
    # Compute x^2 for RMS calculation (on fp32 input)
    ...
    # Apply gamma scaling: input * gamma (using fp32 input)
