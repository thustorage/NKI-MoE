...
def stream_shuffle_broadcast(src, dst):
    ...
    #     )
    shuffle_mask1 = [0] * 32
    nisa.nc_stream_shuffle(src=src[0:1, :], dst=dst[0:32], shuffle_mask=shuffle_mask1)
    nisa.nc_stream_shuffle(src=dst[0:32], dst=dst[32:64], shuffle_mask=shuffle_mask1)
    nisa.nc_stream_shuffle(src=dst[0:64], dst=dst[64:128], shuffle_mask=shuffle_mask1)
